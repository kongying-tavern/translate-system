...
/**
 * 基础语言列表（后端写死，替代已废弃的 base_languages 表方案）。
 * 经 GET /languages 静态接口提供给前端；后端语言 Code 可用性校验（如添加项目语言）也以本列表为准。
 */
export const BASE_LANGUAGES: BaseLanguageData[] = [
  ...
  { languageCode: 'eo', englishName: 'Esperanto', nativeName: 'Esperanto' },
  ...
  { languageCode: 'eu-ES', englishName: 'Basque', nativeName: 'euskara' },
  ...
  { languageCode: 'ga-IE', englishName: 'Irish', nativeName: 'Gaeilge' },
  ...
  { languageCode: 'is-IS', englishName: 'Icelandic', nativeName: 'íslenska' },
  ...
  { languageCode: 'mk-MK', englishName: 'Macedonian', nativeName: 'македонски' },
  { languageCode: 'mn-MN', englishName: 'Mongolian', nativeName: 'монгол' },
  { languageCode: 'ms-MY', englishName: 'Malay', nativeName: 'Bahasa Melayu' },
  { languageCode: 'mt-MT', englishName: 'Maltese', nativeName: 'Malti' },
  { languageCode: 'my-MM', englishName: 'Burmese', nativeName: 'မြန်မာဘာသာ' },
  { languageCode: 'nb-NO', englishName: 'Norwegian Bokmål', nativeName: 'Norsk bokmål' },
  { languageCode: 'ne-NP', englishName: 'Nepali', nativeName: 'नेपाली' },
  ...
  { languageCode: 'sw-KE', englishName: 'Swahili', nativeName: 'Kiswahili' },
  { languageCode: 'ta-IN', englishName: 'Tamil', nativeName: 'தமிழ்' },
  ...
  { languageCode: 'ur-PK', englishName: 'Urdu', nativeName: 'اردو' },
