<template>
  <div class="login-wrap">
    ...
    <div class="input-group">
      ...
      <input v-model="form.password" :type="showPwd ? 'text' : 'password'" placeholder="密码" class="dark-input" />
...
async function handleLogin() {
  ...
  loading.value = true
  try { await auth.login(form.email, form.password); ElMessage.success('登录成功'); router.push('/') } catch { ElMessage.error('邮箱或密码错误') }
